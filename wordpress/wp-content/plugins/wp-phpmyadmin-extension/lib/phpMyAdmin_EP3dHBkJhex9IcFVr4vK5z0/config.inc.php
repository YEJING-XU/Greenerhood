...
$cfg['blowfish_secret']					= '#=Mk+iNV%4n>QnH]bH#wSKBabzS=%&.Q' ;  // i.e. '$b~`lnkwm>^^jNUEE;(4xB$L\'b?."\'o9' 
...
$cfg['PmaAbsoluteUri'] 					= '/wp-content/plugins/wp-phpmyadmin-extension/lib/phpMyAdmin_EP3dHBkJhex9IcFVr4vK5z0/';			//used, if different directory by htaccess ; or parse_url($GLOBALS['PMA_PHP_SELF']);
