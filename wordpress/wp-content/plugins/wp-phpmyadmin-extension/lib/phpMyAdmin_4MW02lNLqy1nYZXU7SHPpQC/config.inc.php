...
$i++;
$cfg['Servers'][$i]['host'] 			= 'ls-0905a0eb376aa01a804000eca1a8d83afda25904.cq17ylcp6xtf.us-east-1.rds.amazonaws.com';
$cfg['Servers'][$i]['port'] 			= '3306';
$cfg['Servers'][$i]['connect_type'] 	= 'tcp';
$cfg['Servers'][$i]['socket'] 			= '';
$cfg['Servers'][$i]['AllowNoPassword']	= false;   // true/false
$cfg['blowfish_secret']					= 'l&<VO>f#=gQlPpd-XBR\'c9pgj7L[Dx$Q' ;  // i.e. '$b~`lnkwm>^^jNUEE;(4xB$L\'b?."\'o9' 
...
$cfg['PmaAbsoluteUri'] 					= '/wp-content/plugins/wp-phpmyadmin-extension/lib/phpMyAdmin_4MW02lNLqy1nYZXU7SHPpQC/';			//used, if different directory by htaccess ; or parse_url($GLOBALS['PMA_PHP_SELF']);
