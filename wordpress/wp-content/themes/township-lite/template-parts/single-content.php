...
<article>
	...
	<?php if( get_theme_mod( 'township_lite_date_hide',true) != '' || get_theme_mod( 'township_lite_comment_hide',true) != '' || get_theme_mod( 'township_lite_author_hide',true) != '') { ?>
        <div class="metabox py-2">
            <?php if( get_theme_mod( 'township_lite_date_hide',true) != '') { ?>
              <span class="entry-date"><i class="far fa-calendar-alt me-2"></i><a href="<?php echo esc_url( get_day_link( $archive_year, $archive_month, $archive_day)); ?>"><?php echo esc_html( get_the_date() ); ?><span class="screen-reader-text"><?php echo esc_html( get_the_date() ); ?></span></a></span>
            <?php }?>
            <?php if( get_theme_mod( 'township_lite_author_hide',true) != '') { ?>
              <span class="entry-author px-3"><i class="fa fa-user me-2" aria-hidden="true"></i><a href="<?php echo esc_url( get_author_posts_url( get_the_author_meta( 'ID' )) ); ?>"><?php esc_html(the_author()); ?><span class="screen-reader-text"><?php esc_html(the_author()); ?></span></a></span>
            <?php }?>
            <?php if( get_theme_mod( 'township_lite_comment_hide',true) != '') { ?>
              <span class="entry-comments"><i class="fa fa-comments me-2" aria-hidden="true"></i><?php comments_number( __('0 Comments','township-lite'), __('0 Comments','township-lite'), __('% Comments','township-lite') ); ?></span>
            <?php }?>
        </div>
    <?php }?>
	...
	if ( is_singular( 'attachment' ) ) {
		...
		if( get_theme_mod( 'township_lite_nav_links',true) != '') {
			...
			the_post_navigation( array(
				'next_text' => '<span class="meta-nav" aria-hidden="true">' . esc_html(get_theme_mod('township_lite_next_text',__( 'Next Post', 'township-lite' ))) . '<i class="fas fa-chevron-right ms-1"></i></span> ' .
					'<span class="screen-reader-text">' . __( 'Next Post', 'township-lite' ) . '</span> ' .
					'',
				'prev_text' => '<span class="meta-nav" aria-hidden="true"><i class="fas fa-chevron-left me-1"></i>' . esc_html(get_theme_mod('township_lite_prev_text',__( 'Previous Post', 'township-lite' ))) . '</span> ' .
