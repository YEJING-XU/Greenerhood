    ...
    <div class="postbox p-3 mb-4">
        <div class="new-text">
            <div class="box-content">
                <h2 class="pt-1"><a href="<?php echo esc_url( get_permalink() ); ?>" title="<?php the_title_attribute(); ?>"><?php esc_html(the_title()); ?><span class="screen-reader-text"><?php esc_html(the_title()); ?></span></a></h2>
                <?php if( get_theme_mod( 'township_lite_date_hide',true) != '' || get_theme_mod( 'township_lite_comment_hide',true) != '' || get_theme_mod( 'township_lite_author_hide',true) != '') { ?>
                    <div class="metabox py-2 mb-3">
                        ...
                        <?php if( get_theme_mod( 'township_lite_author_hide',true) != '') { ?>
                          <span class="entry-author  px-3 me-2"><i class="fa fa-user me-2" aria-hidden="true"></i><a href="<?php echo esc_url( get_author_posts_url( get_the_author_meta( 'ID' )) ); ?>"><?php esc_html(the_author()); ?><span class="screen-reader-text"><?php esc_html(the_author()); ?></span></a></span>
                        <?php }?>
                        <?php if( get_theme_mod( 'township_lite_comment_hide',true) != '') { ?>
                          <span class="entry-comments me-2"><i class="fa fa-comments me-2" aria-hidden="true"></i><?php comments_number( __('0 Comments','township-lite'), __('0 Comments','township-lite'), __('% Comments','township-lite') ); ?></span>
                        <?php }?>
                    </div>
                <?php }?>
