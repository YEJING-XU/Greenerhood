...
function township_lite_customize_register( $wp_customize ) {
	...
	// Preloader
	$wp_customize->add_setting( 'township_lite_preloader_hide',array(
		'default' => false,
      	'sanitize_callback'	=> 'township_lite_sanitize_checkbox'
    ) );
    $wp_customize->add_control('township_lite_preloader_hide',array(
    	'type' => 'checkbox',
        'label' => __( 'Show / Hide Preloader','township-lite' ),
        'section' => 'township_lite_topbar_icon'
    ));

    $wp_customize->add_setting('township_lite_preloader_type',array(
        'default'   => 'center-square',
        'sanitize_callback' => 'township_lite_sanitize_choices'
	));
	$wp_customize->add_control( 'township_lite_preloader_type', array(
		'label' => __( 'Preloader Type','township-lite' ),
		'section' => 'township_lite_topbar_icon',
		'type'  => 'select',
		'settings' => 'township_lite_preloader_type',
		'choices' => array(
		    'center-square' => __('Center Square','township-lite'),
		    'chasing-square' => __('Chasing Square','township-lite'),
	    ),
	));
	
	$wp_customize->add_setting( 'township_lite_preloader_color', array(
	    'default' => '#333333',
	    'sanitize_callback' => 'sanitize_hex_color'
  	));
	$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'township_lite_preloader_color', array(
  		'label' => 'Preloader Color',
	    'section' => 'township_lite_topbar_icon',
	    'settings' => 'township_lite_preloader_color',
  	)));

  	$wp_customize->add_setting( 'township_lite_preloader_bg_color', array(
	    'default' => '#fff',
	    'sanitize_callback' => 'sanitize_hex_color'
  	));
	$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'township_lite_preloader_bg_color', array(
  		'label' => 'Preloader Background Color',
	    'section' => 'township_lite_topbar_icon',
	    'settings' => 'township_lite_preloader_bg_color',
  	)));
	...
	$wp_customize->add_setting( 'township_lite_slider_height', array(
		'default'  => ' ',
		'sanitize_callback'	=> 'township_lite_sanitize_float'
	) );
	$wp_customize->add_control( 'township_lite_slider_height', array(
		'label' => esc_html__('Slider Height','township-lite'),
		'section' => 'township_lite_slidersettings',
		'type'  => 'number',
		'input_attrs' => array(
			'step' => 5,
	...
	$wp_customize->add_setting( 'township_lite_post_blocks', array(
        'default'			=> 'Within box',
        'sanitize_callback'	=> 'township_lite_sanitize_choices'
    ));
    $wp_customize->add_control( 'township_lite_post_blocks', array(
        'section' => 'township_lite_blog_post',
        'type' => 'select',
        'label' => __( 'Post blocks', 'township-lite' ),
        'choices' => array(
            'Within box'  => __( 'Within box', 'township-lite' ),
            'Without box' => __( 'Without box', 'township-lite' ),
    )));

	$wp_customize->add_setting('township_lite_navigation_hide',array(
		'default' => true,
		'sanitize_callback'	=> 'township_lite_sanitize_checkbox'
	));
	$wp_customize->add_control('township_lite_navigation_hide',array(
		'type' => 'checkbox',
		'label' => __('Enable / Disable Post Navigation','township-lite'),
		'section' => 'township_lite_blog_post'
	));
	...
	$wp_customize->add_section( 'township_lite_mobile_media_options' , array(
    	'title'      => __( 'Mobile Media Options', 'township-lite' ),
		'priority'   => null,
		'panel' => 'township_lite_panel_id'
	) );

	$wp_customize->add_setting('township_lite_responsive_open_menu_icon',array(
		'default'	=> 'fas fa-bars',
		'sanitize_callback'	=> 'sanitize_text_field'
	));	
	$wp_customize->add_control(new Township_Lite_Icon_Changer(
        $wp_customize, 'township_lite_responsive_open_menu_icon',array(
		'label'	=> __('Open Menu Icon','township-lite'),
		'section'	=> 'township_lite_mobile_media_options',
		'type'		=> 'icon'
	)));

	$wp_customize->add_setting('township_lite_responsive_close_menu_icon',array(
		'default'	=> 'fas fa-times',
		'sanitize_callback'	=> 'sanitize_text_field'
	));	
	$wp_customize->add_control(new Township_Lite_Icon_Changer(
        $wp_customize, 'township_lite_responsive_close_menu_icon',array(
		'label'	=> __('Close Menu Icon','township-lite'),
		'section'	=> 'township_lite_mobile_media_options',
		'type'		=> 'icon'
	)));
	
    $wp_customize->add_setting('township_lite_responsive_show_back_to_top',array(
        'default' => true,
        'sanitize_callback'	=> 'township_lite_sanitize_checkbox'
	));
	$wp_customize->add_control('township_lite_responsive_show_back_to_top',array(
     	'type' => 'checkbox',
      	'label' => __('Show / Hide Back to Top Button','township-lite'),
      	'section' => 'township_lite_mobile_media_options',
	));

	$wp_customize->add_setting( 'township_lite_responsive_preloader_hide',array(
		'default' => false,
      	'sanitize_callback'	=> 'township_lite_sanitize_checkbox'
    ) );
    $wp_customize->add_control('township_lite_responsive_preloader_hide',array(
    	'type' => 'checkbox',
        'label' => __( 'Show / Hide Preloader','township-lite' ),
        'section' => 'township_lite_mobile_media_options'
    ));
	...
	$wp_customize->add_setting('township_lite_shop_page_pagination',array(
		'default' => true,
		'sanitize_callback'	=> 'township_lite_sanitize_checkbox'
	 ));
	 $wp_customize->add_control('township_lite_shop_page_pagination',array(
		'type' => 'checkbox',
		'label' => __('Enable / Disable Shop page pagination','township-lite'),
		'section' => 'township_lite_woocommerce_options',
	 ));
