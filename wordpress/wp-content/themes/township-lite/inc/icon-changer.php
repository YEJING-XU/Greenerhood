...
class Township_Lite_Icon_Changer extends WP_Customize_Control{
      public $type = 'icon';
            ...
            <label>
                  ...
                  <ul class="icon-list">
                        <div class="social-icon-search">
                              <input class="socialInput" type="text" placeholder="<?php echo esc_attr('Search Icon', 'township-lite'); ?>">
                        </div>
                        <?php
                        $township_lite_font_awesome_icon_array = township_lite_font_awesome_icon_array();
                        foreach ($township_lite_font_awesome_icon_array as $township_lite_font_awesome_icon) {
                              $icon_class = $this->value() == $township_lite_font_awesome_icon ? 'icon-active' : '';
                              echo '<li class='.esc_attr($icon_class).'><i class="'.esc_attr($township_lite_font_awesome_icon).'"></i>
                                    <span class="icons-class">'.esc_attr($township_lite_font_awesome_icon).'</span>
                              </li>';
                        }
                        ?>
                  </ul>
...
function township_lite_customizer_script() {
    wp_enqueue_style( 'font-awesome-1', esc_url(get_template_directory_uri()).'/css/fontawesome-all.css');
}
add_action( 'customize_controls_enqueue_scripts', 'township_lite_customizer_script' );

if(!function_exists('township_lite_font_awesome_icon_array')){
    function township_lite_font_awesome_icon_array(){
        return array("None", 
            "fab fa-500px",
