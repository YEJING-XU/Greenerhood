...
<main id="main" role="main" class="content-aa">
	...
	<?php if( get_theme_mod('township_lite_slider_arrows') != ''){ ?>
		<section id="slider">
		  	<div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel" data-bs-interval="<?php echo esc_attr(get_theme_mod( 'township_lite_slider_speed',3000)) ?>"> 
					  		...
					  		<div class="col-lg-4 col-md-4"> 
					  			<div class="row">
							    	...
							    	<div class="col-lg-9 col-md-9">
							    		<h3 class="pt-md-0"><a href="<?php esc_url(the_permalink()); ?>"><?php esc_html(the_title()); ?><span class="screen-reader-text"><?php esc_html(the_title()); ?></span></a></h3>
